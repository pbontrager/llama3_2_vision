...
# Update FullModelHFCheckpointer to match below
class FullModelHFCheckpointer(_CheckpointerInterface):
    ...
    def load_checkpoint(self) -> Dict[str, Any]:
        ...
        if self._model_type == ModelType.PHI3_MINI:
            ...
            raise NotImplementedError("Safe tensors support for LLaMA3 Vision will be added soon. Pleaee use the FullModelMetaCheckpointer for now.")
        else:
